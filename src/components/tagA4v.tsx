...
export const TagA4v = ({ tag }: ItagA4v) => {
  ...
  return (
    <div
      ...
      <div>
        <div style={{ fontWeight: "500", fontSize: "40pt", padding: "0 0px" }}>{tag.property?.type}</div>
      </div>
      <div>
        <div
          style={{
      ...
      <div style={{ display: "inline-flex", marginBottom: 37, minWidth: "100%" }}>
        <div
          style={{
            display: "inline-flex",
            fontSize: "15pt",
        ...
        <div style={{ display: "inline-flex", fontSize: "40pt", padding: "0 0px" }}>
          <div
            style={{
              width: 270,
              color: "white",
          ...
          {tag?.property?.settings?.[1] ? (
            <div
              style={{
                ...
                backgroundColor: tag?.property?.settings?.[1] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[2] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[2] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[3] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[3] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[4] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[4] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[5] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[5] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[6] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[6] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[7] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[7] ? "#f0f0f0" : "white",
              }}>
          ...
          {tag?.property?.settings?.[8] ? (
            <div
              style={{
                ...
                alignItems: "center",
                justifyContent: "center",
                backgroundColor: tag?.property?.settings?.[8] ? "#f0f0f0" : "white",
              }}>
        ...
        <table className="w-100" style={{ textAlign: "center" }}>
          <thead style={{ fontSize: "24pt" }}>
            <tr>
              ...
              <th style={{ fontSize: "19pt", fontWeight: "500" }}>СТАРАЯ ЦЕНА</th>
              <th style={{ fontSize: "20pt", fontWeight: "500" }}>НОВАЯ ЦЕНА</th>
            </tr>
          </thead>
          <tbody style={{ fontWeight: "500" }}>
            {tag.data?.map((item: any, index: number) => (
              <tr key={index}>
                <td style={{ fontSize: "18pt" }}>{item.name}</td>
                <td style={{ fontSize: "20pt", textDecoration: "line-through" }}>
                  {item.valueOld.replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ")} руб
                </td>
                <td style={{ fontSize: "24pt" }}>{item.valueNew.replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, "$1 ")} руб</td>
              </tr>
            ))}
          </tbody>
        </table>
      ...
      <div>
        <div
          ...
          <div
            ...
            <img src="askona_2.png" width={181} height={55} style={{ paddingTop: 15 }} />
          </div>
        </div>
        <div
          style={{
          ...
          <div
            ...
            <div
              ...
              <div style={{ margin: "1px", display: "block", fontWeight: "500" }}>
