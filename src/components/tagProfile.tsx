  ...
  return (
    ...
    <div className="modal-dialog">
        ...
        <div className="modal-header">
            <h5 className="modal-title" id="exampleModalLabel">Название профиля</h5>
        ...
        <div className="modal-footer">
            ...
            type="button" className="btn btn-primary" data-dismiss="modal">Создать профиль</button>
        </div>
        </div>
    </div>
    </div>
